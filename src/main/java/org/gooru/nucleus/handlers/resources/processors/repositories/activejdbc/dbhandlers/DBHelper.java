...
final class DBHelper {
     ...
     */
    static void populateEntityFromJson(JsonObject inputJson, AJEntityResource resource)
        ...
        for (Map.Entry<String, Object> entry : inputJson) {
            ...
            if (AJEntityResource.CONTENT_FORMAT.equalsIgnoreCase(entry.getKey())) {
                ...
                if (mapValue == null || mapValue.isEmpty()
                    ...
                    setPGObject(resource, AJEntityResource.CONTENT_SUBFORMAT, AJEntityResource.CONTENT_SUBFORMAT_TYPE,
                        mapValue);
                }
            } else {
     ...
     */
    static int updateOwnerDataToCopies(AJEntityResource resource, String ownerResourceId, JsonObject dataToBePropogated,
        String originalCreator) throws SQLException, IllegalArgumentException {
    ...
    static int deleteResourceCopies(AJEntityResource resource, String originalResourceId)
        throws IllegalArgumentException {
        ...
        numRecsUpdated = AJEntityResource.update(updateStmt, AJEntityResource.SQL_DELETERESOURCECOPIES_WHERECLAUSE,
            params.toArray());
        LOGGER.debug(
            "deleteResourceCopies : Update successful and is_deleted set to true for all copies of the resource {} . Number of records updated: {}",
