...
public class ResourceEntityConstants {
  ...
  public static final String[] JSONB_FIELDS = { METADATA, 
                                          TAXONOMY, 
                                          DEPTH_OF_KNOWLEDGE, 
                                          COPYRIGHT_OWNER };

  // not null fields in db
  public static final String[] NOTNULL_FIELDS = { RESOURCE_ID, 
                                            RESOURCE_TITLE, 
                                            CREATOR_ID, 
                                            ORIGINAL_CREATOR_ID, 
                                            CONTENT_FORMAT, 
  ...
  public static final String[] OWNER_SPECIFIC_FIELDS = {RESOURCE_TITLE, 
                                                  RESOURCE_URL, 
                                                  DESCRIPTION, 
                                                  DEPTH_OF_KNOWLEDGE, 
                                                  CONTENT_FORMAT, 
