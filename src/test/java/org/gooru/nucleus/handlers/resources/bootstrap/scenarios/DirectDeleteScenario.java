 ...
 */
public class DirectDeleteScenario implements Scenario {
    ...
    public void playScenario(TestContext context, EventBus eventBus) {
        ...
        System.out.println("Testing direct delete resource");
        eventBus.send(MessagebusEndpoints.MBEP_RESOURCE, RequestBuilder.buildEmptyDefaultRequest(),
            DeliveryOptionsBuilder.buildDeliveryOptionsForDeleteResource(resourceId), reply -> {
                if (reply.succeeded()) {
