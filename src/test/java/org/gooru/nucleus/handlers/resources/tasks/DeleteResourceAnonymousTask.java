 ...
 */
final class DeleteResourceAnonymousTask extends AbstractChainableTaskWithEventBusResponseHandler {
    public DeleteResourceAnonymousTask(String name, EventBus eventBus, TestContext context,
    ...
    public void execute(TestContext context, EventBus eventBus, ChainableTaskExecutor executor) {
        System.out.println("Testing delete resource for anonymous user");
        final String resourceId = provider.resourceId();
        EventBusChainableSender.sendMessage(context, eventBus, RequestBuilder.buildEmptyAnonymousRequest(),
