 ...
 */
public class UpdateResourceUnauthorizedTask extends AbstractChainableTaskWithEventBusResponseHandler {

    public UpdateResourceUnauthorizedTask(String name, EventBus eventBus, TestContext context,
    ...
    public void execute(TestContext context, EventBus eventBus, ChainableTaskExecutor executor) {
        ...
        System.out.println("Testing update resource for unauthorized user");

        request = RequestBuilder.buildUpdateUnauthorizedRequest();
